  ...
  return (
    <>
        ...
        <div className='rounded bg-white w-11/12 mx-auto my-10 self-center p-6'>
          ...
          <p>Our GKV days are the common thread that binds us and being alumni of GKV is a natural 
          continuation of that journey. We all should be connected and cherish the memories of the most 
          important years of our lives spent in the environs of GKV. A major credit for our success in life 
          is attributed to GKV and its unique way of formal and informal teaching, learning and training. 
          Despite being settled in our respective routines and careers and striving for greater heights, 
          we can never forget the contribution of GKV in shaping our lives. We must resolve to find time 
          to pay back to our alma mater in a way which will make GKV a better place to live and study. 
          The Alumni Association of GKV (JAA ) is a forum that can help connect you to your alma mater.
          ...
          mater. GKV is a leading national centre of excellence in higher education which aims to rank among 
          the top universities of the world. GKV believes in excellence combined with social responsibility 
          and commitment, and strives to become a benchmark for Indian universities. It is envisioned that 
          the members of JAA  will work as ambassadors of GKV and make it a global brand. JAA  recognizes the 
          alumni as important stakeholders in GKV's continuing quest to provide quality and meaningful
          ...
          directions for GKV in the 21st century. One of the key objectives of JAA  is also to expand its 
          base of Life Members, who could be associated with GKV and the fellow alumni in various productive
           ways. Association of an alumnus with GKV as a Life Member of JAA  serves as a bridge between the 
