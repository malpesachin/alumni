        ...
        <section className='flex-1 justify-center '>
          <div className="h-20 w-fit flex justify-between">
            ...
            <div className='flex-col justify-between my-auto'>
              <span className='text-3xl font-bold select-none'> GKV ALUMNI ASSOCIATION(REGD.)</span>
              <h4 className='font-semibold select-none'>Gurukul Kangri Vishwavidyalaya</h4>
            </div>
          </div>
        </section>
